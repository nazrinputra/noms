            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">New Incident</h3>
                        <p class="mt-1 text-sm text-gray-600">Please fill out the form to create a new incident.</p>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea id="description" name="description" rows="3"
                                            ...
                                            placeholder="Brief description for the incidents."></textarea>
                                    </div>
                                </div>
